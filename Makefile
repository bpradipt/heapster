...
build: clean deps
	GOOS=linux CGO_ENABLED=0 godep go build ./...
	GOOS=linux CGO_ENABLED=0 godep go build -o heapster k8s.io/heapster/metrics
	GOOS=linux CGO_ENABLED=0 godep go build -o eventer k8s.io/heapster/events
